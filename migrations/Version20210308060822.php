 ...
 */
final class Version20210308060822 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ordre_achat (id INT AUTO_INCREMENT NOT NULL, utilisateur_ordre_achat_id INT DEFAULT NULL, lot_ordre_achat_id INT DEFAULT NULL, autobot TINYINT(1) NOT NULL, montant_max DOUBLE PRECISION NOT NULL, date_creation DATETIME NOT NULL, INDEX IDX_71306AD95E404722 (utilisateur_ordre_achat_id), INDEX IDX_71306AD97461C345 (lot_ordre_achat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE paiement (id INT AUTO_INCREMENT NOT NULL, utilisateur_paiement_id INT DEFAULT NULL, type_paiement VARCHAR(255) NOT NULL, validation_paiement TINYINT(1) NOT NULL, INDEX IDX_B1DC7A1EDEAA49EB (utilisateur_paiement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, lot_produit_id INT DEFAULT NULL, utilisateur_produit_id INT DEFAULT NULL, enchere_gagnante_id INT DEFAULT NULL, stock_produit_id INT DEFAULT NULL, nom_artiste VARCHAR(255) NOT NULL, nom_style VARCHAR(255) NOT NULL, nom_produit VARCHAR(255) NOT NULL, prix_reserve DOUBLE PRECISION NOT NULL, reference_catalogue VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, est_envoyer TINYINT(1) NOT NULL, INDEX IDX_29A5EC277EA4ED4C (lot_produit_id), INDEX IDX_29A5EC273D8CBCED (utilisateur_produit_id), UNIQUE INDEX UNIQ_29A5EC2772FCB4 (enchere_gagnante_id), INDEX IDX_29A5EC27A17D8957 (stock_produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, adresse_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, age INT NOT NULL, email VARCHAR(255) NOT NULL, numero_mobile VARCHAR(255) DEFAULT NULL, numero_fixe VARCHAR(255) DEFAULT NULL, verif_solvabilite TINYINT(1) NOT NULL, verif_identite TINYINT(1) NOT NULL, verif_ressortissant TINYINT(1) NOT NULL, password VARCHAR(255) NOT NULL, est_commissaire_priseur TINYINT(1) NOT NULL, liste_mot_cle VARCHAR(255) NOT NULL, INDEX IDX_1D1C63B34DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ordre_achat ADD CONSTRAINT FK_71306AD95E404722 FOREIGN KEY (utilisateur_ordre_achat_id) REFERENCES utilisateur (id)');
        $this->addSql('ALTER TABLE ordre_achat ADD CONSTRAINT FK_71306AD97461C345 FOREIGN KEY (lot_ordre_achat_id) REFERENCES lot (id)');
        $this->addSql('ALTER TABLE paiement ADD CONSTRAINT FK_B1DC7A1EDEAA49EB FOREIGN KEY (utilisateur_paiement_id) REFERENCES utilisateur (id)');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC277EA4ED4C FOREIGN KEY (lot_produit_id) REFERENCES lot (id)');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC273D8CBCED FOREIGN KEY (utilisateur_produit_id) REFERENCES utilisateur (id)');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC2772FCB4 FOREIGN KEY (enchere_gagnante_id) REFERENCES enchere (id)');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27A17D8957 FOREIGN KEY (stock_produit_id) REFERENCES utilisateur (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ordre_achat DROP FOREIGN KEY FK_71306AD95E404722');
        $this->addSql('ALTER TABLE paiement DROP FOREIGN KEY FK_B1DC7A1EDEAA49EB');
        $this->addSql('ALTER TABLE produit DROP FOREIGN KEY FK_29A5EC273D8CBCED');
